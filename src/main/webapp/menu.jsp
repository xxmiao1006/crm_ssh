									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${ pageContext.request.contextPath }/customer_initAddUI.action" target=main>－ 新增客户</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall>
								...
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/linkman_addUI.action" target=main>－ 新增联系人</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${ pageContext.request.contextPath }/jsp/visit/add.jsp" target=main>－新增客户拜访</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${ pageContext.request.contextPath }/visit_findByPage.action" target=main>－客户拜访列表</A>
													</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${ pageContext.request.contextPath }/customer_findBySource.action"
